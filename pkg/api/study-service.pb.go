...
type ConvertTempParticipantReq struct {
	...
	Token                  *api_types.TokenInfos `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"`
	TemporaryParticipantId string                `protobuf:"bytes,2,opt,name=temporary_participant_id,json=temporaryParticipantId,proto3" json:"temporary_participant_id,omitempty"`
	ProfileId              string                `protobuf:"bytes,3,opt,name=profile_id,json=profileId,proto3" json:"profile_id,omitempty"`
}
...
var file_study_service_study_service_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x09, 0x70, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x49, 0x64, 0x22, 0xe4,
	...
	0x70, 0x61, 0x6e, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x16, 0x74,
	0x65, 0x6d, 0x70, 0x6f, 0x72, 0x61, 0x72, 0x79, 0x50, 0x61, 0x72, 0x74, 0x69, 0x63, 0x69, 0x70,
	0x61, 0x6e, 0x74, 0x49, 0x64, 0x22, 0x4d, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x53, 0x74, 0x75, 0x64,
	...
	0x52, 0x08, 0x64, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x5b, 0x0a, 0x1f, 0x52, 0x65,
	...
	0x69, 0x70, 0x61, 0x6e, 0x74, 0x49, 0x64, 0x22, 0xab, 0x01, 0x0a, 0x19, 0x43, 0x6f, 0x6e, 0x76,
	...
	0x69, 0x70, 0x61, 0x6e, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x16,
	0x74, 0x65, 0x6d, 0x70, 0x6f, 0x72, 0x61, 0x72, 0x79, 0x50, 0x61, 0x72, 0x74, 0x69, 0x63, 0x69,
	0x70, 0x61, 0x6e, 0x74, 0x49, 0x64, 0x12, 0x1d, 0x0a, 0x0a, 0x70, 0x72, 0x6f, 0x66, 0x69, 0x6c,
	0x65, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x70, 0x72, 0x6f, 0x66,
	0x69, 0x6c, 0x65, 0x49, 0x64, 0x32, 0xe3, 0x1c, 0x0a, 0x0f, 0x53, 0x74, 0x75, 0x64, 0x79, 0x53,
	...
	0x65, 0x74, 0x2e, 0x73, 0x74, 0x75, 0x64, 0x79, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	0x2e, 0x46, 0x69, 0x6c, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x28, 0x01, 0x12, 0x73, 0x0a, 0x1c, 0x52,
	0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x54, 0x65, 0x6d, 0x70, 0x6f, 0x72, 0x61, 0x72, 0x79,
	0x50, 0x61, 0x72, 0x74, 0x69, 0x63, 0x69, 0x70, 0x61, 0x6e, 0x74, 0x12, 0x16, 0x2e, 0x67, 0x6f,
	0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x45, 0x6d,
	0x70, 0x74, 0x79, 0x1a, 0x3b, 0x2e, 0x69, 0x6e, 0x66, 0x6c, 0x75, 0x65, 0x6e, 0x7a, 0x61, 0x6e,
	0x65, 0x74, 0x2e, 0x73, 0x74, 0x75, 0x64, 0x79, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
...
var file_study_service_study_service_proto_msgTypes = make([]protoimpl.MessageInfo, 30)
var file_study_service_study_service_proto_goTypes = []interface{}{
	...
	(*RegisterTempParticipantResponse)(nil), // 26: influenzanet.study_service.RegisterTempParticipantResponse
	(*ConvertTempParticipantReq)(nil),       // 27: influenzanet.study_service.ConvertTempParticipantReq
	(*UploadParticipantFileReq_Info)(nil),   // 28: influenzanet.study_service.UploadParticipantFileReq.Info
	nil,                                     // 29: influenzanet.study_service.SurveyResponseQuery.ContextQueryEntry
	nil,                                     // 30: influenzanet.study_service.StudyResponseStatistics.SurveyResponseCountsEntry
	(*StudyForUser)(nil),                    // 31: influenzanet.study_service.StudyForUser
	(*api_types.TokenInfos)(nil),            // 32: influenzanet.shared.TokenInfos
	(*ExpressionArg)(nil),                   // 33: influenzanet.study_service.ExpressionArg
	(*Study)(nil),                           // 34: influenzanet.study_service.Study
	(*Survey)(nil),                          // 35: influenzanet.study_service.Survey
	(*SurveyContext)(nil),                   // 36: influenzanet.study_service.SurveyContext
	(*SurveyResponse)(nil),                  // 37: influenzanet.study_service.SurveyResponse
	(*SurveyInfo)(nil),                      // 38: influenzanet.study_service.SurveyInfo
	(*Study_Member)(nil),                    // 39: influenzanet.study_service.Study.Member
	(*Expression)(nil),                      // 40: influenzanet.study_service.Expression
	(*Study_Props)(nil),                     // 41: influenzanet.study_service.Study.Props
	(*empty.Empty)(nil),                     // 42: google.protobuf.Empty
	(*ResponseExportQuery)(nil),             // 43: influenzanet.study_service.ResponseExportQuery
	(*SurveyInfoExportQuery)(nil),           // 44: influenzanet.study_service.SurveyInfoExportQuery
	(*AssignedSurveys)(nil),                 // 45: influenzanet.study_service.AssignedSurveys
	(*Chunk)(nil),                           // 46: influenzanet.study_service.Chunk
	(*SurveyInfoExport)(nil),                // 47: influenzanet.study_service.SurveyInfoExport
}
var file_study_service_study_service_proto_depIdxs = []int32{
	31, // 0: influenzanet.study_service.StudiesForUser.studies:type_name -> influenzanet.study_service.StudyForUser
	28, // 1: influenzanet.study_service.UploadParticipantFileReq.info:type_name -> influenzanet.study_service.UploadParticipantFileReq.Info
	4,  // 2: influenzanet.study_service.FileInfo.referenced_in:type_name -> influenzanet.study_service.FileObjectReference
	32, // 3: influenzanet.study_service.SurveyResponseQuery.token:type_name -> influenzanet.shared.TokenInfos
	29, // 4: influenzanet.study_service.SurveyResponseQuery.context_query:type_name -> influenzanet.study_service.SurveyResponseQuery.ContextQueryEntry
	30, // 5: influenzanet.study_service.StudyResponseStatistics.survey_response_counts:type_name -> influenzanet.study_service.StudyResponseStatistics.SurveyResponseCountsEntry
	33, // 6: influenzanet.study_service.ProfilesWithConditionReq.condition:type_name -> influenzanet.study_service.ExpressionArg
	0,  // 7: influenzanet.study_service.ServiceStatus.status:type_name -> influenzanet.study_service.ServiceStatus.StatusValue
	32, // 8: influenzanet.study_service.NewStudyRequest.token:type_name -> influenzanet.shared.TokenInfos
	34, // 9: influenzanet.study_service.NewStudyRequest.study:type_name -> influenzanet.study_service.Study
	35, // 10: influenzanet.study_service.SurveyAndContext.survey:type_name -> influenzanet.study_service.Survey
	36, // 11: influenzanet.study_service.SurveyAndContext.context:type_name -> influenzanet.study_service.SurveyContext
	37, // 12: influenzanet.study_service.SurveyAndContext.prefill:type_name -> influenzanet.study_service.SurveyResponse
	32, // 13: influenzanet.study_service.StudyReferenceReq.token:type_name -> influenzanet.shared.TokenInfos
	38, // 14: influenzanet.study_service.SurveyInfoResp.infos:type_name -> influenzanet.study_service.SurveyInfo
	32, // 15: influenzanet.study_service.AddSurveyReq.token:type_name -> influenzanet.shared.TokenInfos
	35, // 16: influenzanet.study_service.AddSurveyReq.survey:type_name -> influenzanet.study_service.Survey
	32, // 17: influenzanet.study_service.SubmitResponseReq.token:type_name -> influenzanet.shared.TokenInfos
	37, // 18: influenzanet.study_service.SubmitResponseReq.response:type_name -> influenzanet.study_service.SurveyResponse
	32, // 19: influenzanet.study_service.EnterStudyRequest.token:type_name -> influenzanet.shared.TokenInfos
	32, // 20: influenzanet.study_service.LeaveStudyMsg.token:type_name -> influenzanet.shared.TokenInfos
	32, // 21: influenzanet.study_service.SurveyReferenceRequest.token:type_name -> influenzanet.shared.TokenInfos
	32, // 22: influenzanet.study_service.GetStudiesForUserReq.token:type_name -> influenzanet.shared.TokenInfos
	34, // 23: influenzanet.study_service.Studies.studies:type_name -> influenzanet.study_service.Study
	32, // 24: influenzanet.study_service.StudyMemberReq.token:type_name -> influenzanet.shared.TokenInfos
	39, // 25: influenzanet.study_service.StudyMemberReq.member:type_name -> influenzanet.study_service.Study.Member
	32, // 26: influenzanet.study_service.StudyRulesReq.token:type_name -> influenzanet.shared.TokenInfos
	40, // 27: influenzanet.study_service.StudyRulesReq.rules:type_name -> influenzanet.study_service.Expression
	32, // 28: influenzanet.study_service.StudyStatusReq.token:type_name -> influenzanet.shared.TokenInfos
	32, // 29: influenzanet.study_service.StudyPropsReq.token:type_name -> influenzanet.shared.TokenInfos
	41, // 30: influenzanet.study_service.StudyPropsReq.props:type_name -> influenzanet.study_service.Study.Props
	32, // 31: influenzanet.study_service.ConvertTempParticipantReq.token:type_name -> influenzanet.shared.TokenInfos
	32, // 32: influenzanet.study_service.UploadParticipantFileReq.Info.token:type_name -> influenzanet.shared.TokenInfos
	2,  // 33: influenzanet.study_service.UploadParticipantFileReq.Info.file_type:type_name -> influenzanet.study_service.FileType
	42, // 34: influenzanet.study_service.StudyServiceApi.Status:input_type -> google.protobuf.Empty
	16, // 35: influenzanet.study_service.StudyServiceApi.EnterStudy:input_type -> influenzanet.study_service.EnterStudyRequest
	32, // 36: influenzanet.study_service.StudyServiceApi.GetAssignedSurveys:input_type -> influenzanet.shared.TokenInfos
	...
	32, // 40: influenzanet.study_service.StudyServiceApi.DeleteParticipantData:input_type -> influenzanet.shared.TokenInfos
	...
	42, // 42: influenzanet.study_service.StudyServiceApi.RegisterTemporaryParticipant:input_type -> google.protobuf.Empty
	27, // 43: influenzanet.study_service.StudyServiceApi.ConvertTemporaryToParticipant:input_type -> influenzanet.study_service.ConvertTempParticipantReq
	19, // 44: influenzanet.study_service.StudyServiceApi.GetStudiesForUser:input_type -> influenzanet.study_service.GetStudiesForUserReq
	32, // 45: influenzanet.study_service.StudyServiceApi.GetActiveStudies:input_type -> influenzanet.shared.TokenInfos
	12, // 46: influenzanet.study_service.StudyServiceApi.GetStudySurveyInfos:input_type -> influenzanet.study_service.StudyReferenceReq
	8,  // 47: influenzanet.study_service.StudyServiceApi.HasParticipantStateWithCondition:input_type -> influenzanet.study_service.ProfilesWithConditionReq
	10, // 48: influenzanet.study_service.StudyServiceApi.CreateNewStudy:input_type -> influenzanet.study_service.NewStudyRequest
	32, // 49: influenzanet.study_service.StudyServiceApi.GetAllStudies:input_type -> influenzanet.shared.TokenInfos
	12, // 50: influenzanet.study_service.StudyServiceApi.GetStudy:input_type -> influenzanet.study_service.StudyReferenceReq
	21, // 51: influenzanet.study_service.StudyServiceApi.SaveStudyMember:input_type -> influenzanet.study_service.StudyMemberReq
	21, // 52: influenzanet.study_service.StudyServiceApi.RemoveStudyMember:input_type -> influenzanet.study_service.StudyMemberReq
	22, // 53: influenzanet.study_service.StudyServiceApi.SaveStudyRules:input_type -> influenzanet.study_service.StudyRulesReq
	23, // 54: influenzanet.study_service.StudyServiceApi.SaveStudyStatus:input_type -> influenzanet.study_service.StudyStatusReq
	24, // 55: influenzanet.study_service.StudyServiceApi.SaveStudyProps:input_type -> influenzanet.study_service.StudyPropsReq
	14, // 56: influenzanet.study_service.StudyServiceApi.SaveSurveyToStudy:input_type -> influenzanet.study_service.AddSurveyReq
	18, // 57: influenzanet.study_service.StudyServiceApi.GetSurveyDefForStudy:input_type -> influenzanet.study_service.SurveyReferenceRequest
	18, // 58: influenzanet.study_service.StudyServiceApi.RemoveSurveyFromStudy:input_type -> influenzanet.study_service.SurveyReferenceRequest
	12, // 59: influenzanet.study_service.StudyServiceApi.DeleteStudy:input_type -> influenzanet.study_service.StudyReferenceReq
	22, // 60: influenzanet.study_service.StudyServiceApi.RunRules:input_type -> influenzanet.study_service.StudyRulesReq
	6,  // 61: influenzanet.study_service.StudyServiceApi.GetStudyResponseStatistics:input_type -> influenzanet.study_service.SurveyResponseQuery
	6,  // 62: influenzanet.study_service.StudyServiceApi.StreamStudyResponses:input_type -> influenzanet.study_service.SurveyResponseQuery
	43, // 63: influenzanet.study_service.StudyServiceApi.GetResponsesWideFormatCSV:input_type -> influenzanet.study_service.ResponseExportQuery
	43, // 64: influenzanet.study_service.StudyServiceApi.GetResponsesLongFormatCSV:input_type -> influenzanet.study_service.ResponseExportQuery
	43, // 65: influenzanet.study_service.StudyServiceApi.GetResponsesFlatJSON:input_type -> influenzanet.study_service.ResponseExportQuery
	44, // 66: influenzanet.study_service.StudyServiceApi.GetSurveyInfoPreviewCSV:input_type -> influenzanet.study_service.SurveyInfoExportQuery
	44, // 67: influenzanet.study_service.StudyServiceApi.GetSurveyInfoPreview:input_type -> influenzanet.study_service.SurveyInfoExportQuery
	9,  // 68: influenzanet.study_service.StudyServiceApi.Status:output_type -> influenzanet.study_service.ServiceStatus
	45, // 69: influenzanet.study_service.StudyServiceApi.EnterStudy:output_type -> influenzanet.study_service.AssignedSurveys
	45, // 70: influenzanet.study_service.StudyServiceApi.GetAssignedSurveys:output_type -> influenzanet.study_service.AssignedSurveys
	11, // 71: influenzanet.study_service.StudyServiceApi.GetAssignedSurvey:output_type -> influenzanet.study_service.SurveyAndContext
	45, // 72: influenzanet.study_service.StudyServiceApi.SubmitResponse:output_type -> influenzanet.study_service.AssignedSurveys
	45, // 73: influenzanet.study_service.StudyServiceApi.LeaveStudy:output_type -> influenzanet.study_service.AssignedSurveys
	9,  // 74: influenzanet.study_service.StudyServiceApi.DeleteParticipantData:output_type -> influenzanet.study_service.ServiceStatus
	5,  // 75: influenzanet.study_service.StudyServiceApi.UploadParticipantFile:output_type -> influenzanet.study_service.FileInfo
	26, // 76: influenzanet.study_service.StudyServiceApi.RegisterTemporaryParticipant:output_type -> influenzanet.study_service.RegisterTempParticipantResponse
	9,  // 77: influenzanet.study_service.StudyServiceApi.ConvertTemporaryToParticipant:output_type -> influenzanet.study_service.ServiceStatus
	1,  // 78: influenzanet.study_service.StudyServiceApi.GetStudiesForUser:output_type -> influenzanet.study_service.StudiesForUser
	20, // 79: influenzanet.study_service.StudyServiceApi.GetActiveStudies:output_type -> influenzanet.study_service.Studies
	13, // 80: influenzanet.study_service.StudyServiceApi.GetStudySurveyInfos:output_type -> influenzanet.study_service.SurveyInfoResp
	9,  // 81: influenzanet.study_service.StudyServiceApi.HasParticipantStateWithCondition:output_type -> influenzanet.study_service.ServiceStatus
	34, // 82: influenzanet.study_service.StudyServiceApi.CreateNewStudy:output_type -> influenzanet.study_service.Study
	20, // 83: influenzanet.study_service.StudyServiceApi.GetAllStudies:output_type -> influenzanet.study_service.Studies
	34, // 84: influenzanet.study_service.StudyServiceApi.GetStudy:output_type -> influenzanet.study_service.Study
	34, // 85: influenzanet.study_service.StudyServiceApi.SaveStudyMember:output_type -> influenzanet.study_service.Study
	34, // 86: influenzanet.study_service.StudyServiceApi.RemoveStudyMember:output_type -> influenzanet.study_service.Study
	34, // 87: influenzanet.study_service.StudyServiceApi.SaveStudyRules:output_type -> influenzanet.study_service.Study
	34, // 88: influenzanet.study_service.StudyServiceApi.SaveStudyStatus:output_type -> influenzanet.study_service.Study
	34, // 89: influenzanet.study_service.StudyServiceApi.SaveStudyProps:output_type -> influenzanet.study_service.Study
	35, // 90: influenzanet.study_service.StudyServiceApi.SaveSurveyToStudy:output_type -> influenzanet.study_service.Survey
	35, // 91: influenzanet.study_service.StudyServiceApi.GetSurveyDefForStudy:output_type -> influenzanet.study_service.Survey
	9,  // 92: influenzanet.study_service.StudyServiceApi.RemoveSurveyFromStudy:output_type -> influenzanet.study_service.ServiceStatus
	9,  // 93: influenzanet.study_service.StudyServiceApi.DeleteStudy:output_type -> influenzanet.study_service.ServiceStatus
	25, // 94: influenzanet.study_service.StudyServiceApi.RunRules:output_type -> influenzanet.study_service.RuleRunSummary
	7,  // 95: influenzanet.study_service.StudyServiceApi.GetStudyResponseStatistics:output_type -> influenzanet.study_service.StudyResponseStatistics
	37, // 96: influenzanet.study_service.StudyServiceApi.StreamStudyResponses:output_type -> influenzanet.study_service.SurveyResponse
	46, // 97: influenzanet.study_service.StudyServiceApi.GetResponsesWideFormatCSV:output_type -> influenzanet.study_service.Chunk
	46, // 98: influenzanet.study_service.StudyServiceApi.GetResponsesLongFormatCSV:output_type -> influenzanet.study_service.Chunk
	46, // 99: influenzanet.study_service.StudyServiceApi.GetResponsesFlatJSON:output_type -> influenzanet.study_service.Chunk
...
func file_study_service_study_service_proto_init() {
	...
	file_study_service_study_service_proto_msgTypes[27].OneofWrappers = []interface{}{
...
type StudyServiceApiClient interface {
	...
	RegisterTemporaryParticipant(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*RegisterTempParticipantResponse, error)
...
func (c *studyServiceApiClient) RegisterTemporaryParticipant(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*RegisterTempParticipantResponse, error) {
...
type StudyServiceApiServer interface {
	...
	//rpc DeleteParticipantFiles(DeleteParticipantFilesReq) returns (DeleteParticipantFilesResp);
	//rpc BulkDownloadParticipantFiles(BulkDownloadParticipantFilesReq) returns (stream Chunk);
	RegisterTemporaryParticipant(context.Context, *empty.Empty) (*RegisterTempParticipantResponse, error)
...
func (*UnimplementedStudyServiceApiServer) RegisterTemporaryParticipant(context.Context, *empty.Empty) (*RegisterTempParticipantResponse, error) {
...
func _StudyServiceApi_RegisterTemporaryParticipant_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StudyServiceApiServer).RegisterTemporaryParticipant(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
