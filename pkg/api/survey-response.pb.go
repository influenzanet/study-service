...
type SurveyResponses struct {
	...
	Responses *SurveyResponse `protobuf:"bytes,1,opt,name=responses,proto3" json:"responses,omitempty"`
}
...
var file_api_survey_response_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x69, 0x6e, 0x66, 0x2e, 0x73, 0x75, 0x72, 0x76, 0x65,
